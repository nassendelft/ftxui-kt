...
publishing {
    publications.withType<MavenPublication>().all {
        ...
        pom {
            ...
            url.set("https://github.com/nassendelft/ftxui-kt")
            ...
            scm {
                connection = "scm:git:git://github.com/nassendelft/ftxui-kt.git"
                developerConnection = "scm:git:ssh://github.com/nassendelft/ftxui-kt.git"
                url = "https://github.com/nassendelft/ftxui-kt"
            }
        }
    }
}
...
publishing {
    repositories {
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/nassendelft/ftxui-kt")
            credentials {
